...
export function FooterContent() {
  return (
    <footer
      aria-label="Rodapé"
      className="relative overflow-hidden bg-gradient-to-t from-black-soft via-wine/15 to-black-soft py-16 px-5 sm:px-6"
    >
      {/* Top divider */}
            ...
            {content.footer.socialLinks.map((link) => (
              <li key={link.label}>
                <a
                  ...
                  className="text-nude/70 hover:text-gold transition-colors text-sm font-medium"
                >
                  {link.label}
                </a>
              </li>
